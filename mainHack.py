#before this script: run from client repo: console\publicTestBenchmark\modDataForOpenCap.py
#after this script: read output from C:\openCapTestSet\Data\FT026g-2021-09-14-09-47-58\MarkerData\OpenPose_default\PostAugmentation_v0.3\trial_LSTM.trc
"""
...
def main(sessionName, trialName, trial_id, camerasToUse=['all'],
    ...
    # %% High-level settings.
    # Camera calibration.
    runCameraCalibration = True     #It will load of the existing calibration file.
    # Pose detection.
    ...
    if runPoseDetection:
        ...
        '''
        rotationAngles={}   #this rotation is used to match opensim convention. Without opensim section, just leave it the same. 
